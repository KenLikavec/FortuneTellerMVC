...
namespace Fortune_Teller_MVC.Controllers
{
    public class FavoriteColorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FavoriteColorID,FavoriteColorName")] FavoriteColor favoriteColor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FavoriteColorID,FavoriteColorName")] FavoriteColor favoriteColor)
        {
            if (ModelState.IsValid)
            {
